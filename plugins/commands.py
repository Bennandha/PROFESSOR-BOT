...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton("📢 𝑼𝒑𝒅𝒂𝒕𝒆 📢", url="")
            ],[      
            InlineKeyboardButton("ℹ️ 𝑯𝒆𝒍𝒑 ℹ️", callback_data="help"),
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            ...
            InlineKeyboardButton("🔍 𝑺𝒆𝒂𝒓𝒄𝒉 🔍", switch_inline_query_current_chat=''), 
            InlineKeyboardButton("📢 𝑼𝒑𝒅𝒂𝒕𝒆 📢", url="https://t.me/mkn_bots_updates")
            ],[      
            InlineKeyboardButton("ℹ️ 𝑯𝒆𝒍𝒑 ℹ️", callback_data="help"),
            InlineKeyboardButton("💫 𝑨𝒃𝒐𝒖𝒕 💫", callback_data="about")
        ]]
...
async def settings(client, message):
    ...
    if settings is not None:
        buttons = [[
            ...
            InlineKeyboardButton('Button Style', callback_data=f'setgs#button#{settings["button"]}#{str(grp_id)}'),
            ...
            InlineKeyboardButton('File ', callback_data=f'setgs#file_secure#{settings["file_secure"]}#{str(grp_id)}'),
